...
function RubriquePaie() {
  ...
  const handleSave = () => {
    ...
    // on autorise l'édition de SB (libellé, etc.) mais pas de montant côté front
                                  ...
                                  return (
                                    <tr key={r.id}>
                                      ...
                                      <td>
                                        ...
                                        {isSB(r) && <span className="badge bg-secondary ms-2">Contrat</span>}
                                      </td>
                                      <td>{r.nomRubrique}</td>
              ...
              <div className="modal-body">
                ...
                {(code || "").toUpperCase() === "SB" && (
                  <div className="alert alert-info mt-3 mb-0 py-2">
                    La **valeur** de SB n’est jamais saisie ici. Elle provient du <strong>contrat (EmployerSociete.salaireBase)</strong>.
                  </div>
                )}
